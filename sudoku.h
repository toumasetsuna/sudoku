...
void generate_shudu_game(int shudu_game[9][9], int blank_num, bool unique);
void generate_shudu_final(int shudu_final[9][9]);
void generate_shudu_final_list(int shudu_final_list[][9][9], int num);
void generate_shudu_final_list_2(int shudu_final_list[][9][9], int num);
void print_shudu(int shudu[9][9]);
bool check_ans_unique(int shudu[9][9]);
bool compare_shudu(int shudu1[9][9], int shudu2[9][9]);
